	...
	tests := []struct {
		...
		},
		{
			...
			Want: []*TestValue{
				...
				{ID: 4, Op: ssafir.OpConstantInt64, Extra: &Alloc{Dst: x86.RAX, Src: x86.RDI}, Uses: 1, Code: `(len "bar")`},
				...
				{ID: 3, Op: ssafir.OpCopy, Extra: &Alloc{Dst: x86.RCX, Src: x86.RDI}, Uses: 1, Code: `(let length (len "foobar"))`},
				...
				{ID: 7, Op: ssafir.OpConstantUntypedInt, Extra: &Alloc{Dst: x86.RDX, Src: x86.RDI}, Uses: 1, Code: `7`},
				...
				{ID: 9, Op: ssafir.OpConstantString, Extra: &Alloc{Dst: x86.R8, Src: x86.RDI}, Uses: 1, Code: `"foo"`},
