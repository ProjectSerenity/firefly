	...
	tests := []struct {
		...
		},
		{
			...
			Want: []*TestValue{
				...
				{ID: 4, Op: ssafir.OpDrop, Extra: &Alloc{Src: x86.RDI}, Uses: 1, Code: `(len "bar")`},
				...
				{ID: 3, Op: ssafir.OpDrop, Extra: &Alloc{Src: x86.RDI}, Uses: 1, Code: `(let length (len "foobar"))`},
				{ID: 9, Op: ssafir.OpConstantUntypedInt, Extra: &Alloc{Dst: x86.RDI, Data: constant.MakeInt64(7)}, Uses: 1, Code: `7`},
				{ID: 10, Op: ssafir.OpFunctionCall, Extra: new(types.Function), Uses: 1, Code: `(double 7)`},
				{ID: 9, Op: ssafir.OpDrop, Extra: &Alloc{Src: x86.RDI}, Uses: 1, Code: `7`},
				...
				{ID: 13, Op: ssafir.OpFunctionCall, Extra: new(types.Function), Uses: 1, Code: `(half-string-length "foo")`},
				{ID: 12, Op: ssafir.OpDrop, Extra: &Alloc{Src: x86.RDI}, Uses: 1, Code: `"foo"`},
				{ID: 12, Op: ssafir.OpDrop, Extra: &Alloc{Src: x86.RSI}, Uses: 1, Code: `"foo"`},
				{ID: 16, Op: ssafir.OpConstantInt64, Extra: &Alloc{Dst: x86.RDI, Data: int64(17)}, Uses: 1, Code: `val`},
				{ID: 17, Op: ssafir.OpFunctionCall, Extra: new(types.Function), Uses: 1, Code: `(double val)`},
