	...
	tests := []struct {
		...
		},
		{
			...
			Want: []*TestValue{
				...
				{ID: 7, Op: ssafir.OpDrop, Extra: &Alloc{Src: x86.RDI}, Uses: 1, Code: `7`},
				...
				{ID: 9, Op: ssafir.OpDrop, Extra: &Alloc{Src: x86.RDI}, Uses: 1, Code: `"foo"`},
				{ID: 9, Op: ssafir.OpDrop, Extra: &Alloc{Src: x86.RSI}, Uses: 1, Code: `"foo"`},
				...
				{ID: 12, Op: ssafir.OpDrop, Extra: &Alloc{Src: x86.RDI}, Uses: 1, Code: `val`},
