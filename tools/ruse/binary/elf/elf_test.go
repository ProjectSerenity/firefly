	...
	}{
		{
			...
			Want: &elf.File{
				FileHeader: elf.FileHeader{
					...
					Entry:      0x0123456789abcdef + 0x40 + 3*0x38,
				},
				...
				Progs: []*elf.Prog{
					{
						ProgHeader: elf.ProgHeader{
							...
							Off:    0x40 + 3*0x38,
							Vaddr:  0x0123456789abcdef + 0x40 + 3*0x38,
							Paddr:  0x0123456789abcdef + 0x40 + 3*0x38,
							Filesz: 10,
							Memsz:  10,
							Align:  0x1000,
						},
					},
					{
						ProgHeader: elf.ProgHeader{
							...
							Off:    0x40 + 3*0x38 + 10,
							Vaddr:  0xf1e2d3c4b5a60798 + 0x40 + 3*0x38 + 10,
							Paddr:  0xf1e2d3c4b5a60798 + 0x40 + 3*0x38 + 10,
							Filesz: 0,
							Memsz:  1,
							Align:  0x1000,
						},
					},
					{
						ProgHeader: elf.ProgHeader{
							...
							Flags:  elf.PF_R,
							Off:    0x40 + 3*0x38 + 10,
							Vaddr:  0xfedcba9876543210 + 0x40 + 3*0x38 + 10,
							Paddr:  0xfedcba9876543210 + 0x40 + 3*0x38 + 10,
							Filesz: 13,
							Memsz:  13,
							Align:  0x1000,
						},
