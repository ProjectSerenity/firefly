...
var encodeReplace = map[[2]string]string{
	...
	{"bnd2", "ModRM:reg"}:                      "bnd1",
	{"bnd", "ModRM:reg"}:                       "bnd1",
	{"<eax>", "Implicit EAX"}:                  "<EAX>",
	{"<edx>", "Implicit EDX"}:                  "<EDX>",
	{"k1{k2}", "ModRM:reg"}:                    "k1 {k2}",
	{"k1+1", "ModRM:reg"}:                      "k1",
	{"k1", "ModRM:r/m"}:                        "k2",
	{"k2 {k1}", "ModRM:reg"}:                   "k1 {k2}",
	{"k2", "VEX.1vvv"}:                         "kV",
	{"k3", "ModRM:r/m"}:                        "k2",
	{"m16{k1}", "ModRM:r/m"}:                   "m16 {k1}",
	{"m128{k1}", "ModRM:r/m"}:                  "m128 {k1}",
	{"m256{k1}", "ModRM:r/m"}:                  "m256 {k1}",
	{"m512{k1}", "ModRM:r/m"}:                  "m512 {k1}",
	{"mm1", "ModRM:r/m"}:                       "mm2",
	{"mm2", "ModRM:reg"}:                       "mm1",
	...
	{"mm", "ModRM:r/m"}:                        "mm2",
	{"r16", "opcode + rd"}:                     "r16op",
	{"r16/r32/r64", "ModRM:r/m"}:               "rmr16/rmr32/rmr64",
	{"r32a", "ModRM:reg"}:                      "r32",
	{"r32b", "EVEX.vvvv"}:                      "r32V",
	{"r32b", "VEX.vvvv"}:                       "r32V",
	{"r32", "EVEX.vvvv"}:                       "r32V",
	...
	{"r64", "VEX.vvvv"}:                        "r64V",
	{"r8", "opcode + rd"}:                      "r8op",
	{"r/m32 {er}", "ModRM:r/m"}:                "r/m32{er}",
	{"r/m64 {er}", "ModRM:r/m"}:                "r/m64{er}",
	{"reg/m16", "ModRM:r/m"}:                   "r32/m16",
	{"reg/m32", "ModRM:r/m"}:                   "r/m32",
	{"reg", "ModRM:r/m"}:                       "rmr8/rmr16/rmr32/rmr64",
	{"ST", "ST(0)"}:                            "ST(0)",
	{"tmm3", "VEX.vvvv"}:                       "tmmV",
	{"xmm0", "ModRM:reg"}:                      "xmm1",
	{"xmm0 {k1}{z}", "ModRM:reg"}:              "xmm1 {k1}{z}",
	{"xmm1", "EVEX.vvvv"}:                      "xmmV",
	{"xmm1 {k1}{z}", "VEX.vvvv"}:               "xmmV {k1}{z}",
	{"xmm1 {k1}{z}", "EVEX.vvvv"}:              "xmmV {k1}{z}",
	{"xmm1{k1}{z}", "ModRM:reg"}:               "xmm1 {k1}{z}",
	{"xmm1{k1}{z}", "ModRM:r/m"}:               "xmm2 {k1}{z}",
	{"xmm1 {k1}{z}", "ModRM:r/m"}:              "xmm2 {k1}{z}",
	{"xmm1/m128/ m16bcst", "ModRM:r/m"}:        "xmm2/m128/m16bcst",
	{"xmm1/m128 {k1}{z}", "ModRM:r/m"}:         "xmm2/m128 {k1}{z}",
	{"xmm1/m128", "ModRM:r/m"}:                 "xmm2/m128",
	{"xmm1/m16 {k1}{z}", "ModRM:r/m"}:          "xmm2/m16 {k1}{z}",
	{"xmm1/m16 {sae}", "ModRM:r/m"}:            "xmm2/m16{sae}",
	{"xmm1/m16 {er}", "ModRM:r/m"}:             "xmm2/m16{er}",
	{"xmm1/m16", "ModRM:r/m"}:                  "xmm2/m16",
	{"xmm1/m256", "ModRM:r/m"}:                 "xmm2/m256",
	{"xmm1/m32{er}", "ModRM:r/m"}:              "xmm2/m32{er}",
	{"xmm1/m32", "ModRM:r/m"}:                  "xmm2/m32",
	{"xmm1/m32{sae}", "ModRM:r/m"}:             "xmm2/m32{sae}",
	{"xmm1/m32 {k1}{z}", "ModRM:r/m"}:          "xmm2/m32 {k1}{z}",
	{"xmm1/m64{er}", "ModRM:r/m"}:              "xmm2/m64{er}",
	{"xmm1/m64 {k1}{z}", "ModRM:r/m"}:          "xmm2/m64 {k1}{z}",
	{"xmm1/m64", "ModRM:r/m"}:                  "xmm2/m64",
	{"xmm1/m64{sae}", "ModRM:r/m"}:             "xmm2/m64{sae}",
	{"xmm1", "ModRM:r/m"}:                      "xmm2",
	{"xmm1", "VEX.vvvv"}:                       "xmmV",
	{"xmm2", "EVEX.vvvv"}:                      "xmmV",
	{"xmm2/ m32/m16bcst", "ModRM:r/m"}:         "xmm2/m32/m16bcst",
	{"xmm2/ m64/m16bcst", "ModRM:r/m"}:         "xmm2/m64/m16bcst",
	{"xmm2/ m128", "ModRM:r/m"}:                "xmm2/m128", // VPSLLDQ typo.
	{"xmm2/ m128/m16bcst {sae}", "ModRM:r/m"}:  "xmm2/m128/m16bcst{sae}",
	{"xmm2/ m128/m16bcst {er}", "ModRM:r/m"}:   "xmm2/m128/m16bcst{er}",
	{"xmm2/ m128/m16bcst", "ModRM:r/m"}:        "xmm2/m128/m16bcst",
	{"xmm2/m128/ m16bcst", "ModRM:r/m"}:        "xmm2/m128/m16bcst",
	{"xmm2/ m128/m32bcst", "ModRM:r/m"}:        "xmm2/m128/m32bcst",
	{"xmm2/ m128/m64bcst", "ModRM:r/m"}:        "xmm2/m128/m64bcst",
	{"xmm2/mm128", "ModRM:r/m"}:                "xmm2/m128", // VMOVDQU32 typo.
	{"xmm2", "ModRM:reg"}:                      "xmm1",
	{"xmm2", "VEX.vvvv"}:                       "xmmV",
	{"xmm2+3", "EVEX.vvvv"}:                    "xmmV",
	{"xmm2/m16 {sae}", "ModRM:r/m"}:            "xmm2/m16{sae}",
	{"xmm3/ m128/m16bcst", "ModRM:r/m"}:        "xmm2/m128/m16bcst",
	{"xmm3/m128/m16bcst", "ModRM:r/m"}:         "xmm2/m128/m16bcst",
	{"xmm3/m128/m32bcst", "ModRM:r/m"}:         "xmm2/m128/m32bcst",
	{"xmm3/m128/m64bcst", "ModRM:r/m"}:         "xmm2/m128/m64bcst",
	{"xmm3/m128", "ModRM:r/m"}:                 "xmm2/m128",
	{"xmm3/m16", "ModRM:r/m"}:                  "xmm2/m16",
	{"xmm3/m256", "ModRM:r/m"}:                 "xmm2/m256",
	{"xmm3/ m16 {sae}", "ModRM:r/m"}:           "xmm2/m16{sae}",
	{"xmm3/ m16 {er}", "ModRM:r/m"}:            "xmm2/m16{er}",
	{"xmm3/ m16", "ModRM:r/m"}:                 "xmm2/m16",
	{"xmm3/m16 {sae}", "ModRM:r/m"}:            "xmm2/m16{sae}",
	{"xmm3/m16 {er}", "ModRM:r/m"}:             "xmm2/m16{er}",
	{"xmm3/m32{er}", "ModRM:r/m"}:              "xmm2/m32{er}",
	{"xmm3/m32 {er}", "ModRM:r/m"}:             "xmm2/m32{er}",
	{"xmm3/m32", "ModRM:r/m"}:                  "xmm2/m32",
	{"xmm3/m32{sae}", "ModRM:r/m"}:             "xmm2/m32{sae}",
	{"xmm3/m32 {sae}", "ModRM:r/m"}:            "xmm2/m32{sae}",
	{"xmm3/m64{er}", "ModRM:r/m"}:              "xmm2/m64{er}",
	{"xmm3/m64 {er}", "ModRM:r/m"}:             "xmm2/m64{er}",
	{"xmm3/m64{sae}", "ModRM:r/m"}:             "xmm2/m64{sae}",
	{"xmm3/m64 {sae}", "ModRM:r/m"}:            "xmm2/m64{sae}",
	...
	{"ymm0", "ModRM:reg"}:                      "ymm1",
	{"ymm1", "EVEX.vvvv"}:                      "ymmV",
	{"ymm1 {k1}{z}", "VEX.vvvv"}:               "ymmV {k1}{z}",
	{"ymm1 {k1}{z}", "EVEX.vvvv"}:              "ymmV {k1}{z}",
	{"ymm1{k1}{z}", "ModRM:reg"}:               "ymm1 {k1}{z}",
	{"ymm1{k1}{z}", "ModRM:r/m"}:               "ymm2 {k1}{z}",
	{"ymm1/m256/ m16bcst", "ModRM:r/m"}:        "ymm2/m256/m16bcst",
	{"ymm1/m128", "ModRM:r/m"}:                 "ymm2/m128",
	{"ymm1/m16", "ModRM:r/m"}:                  "ymm2/m16",
	{"ymm1/m256 {k1}{z}", "ModRM:r/m"}:         "ymm2/m256 {k1}{z}",
	...
	{"ymm2/m256/m16bcst {sae}", "ModRM:r/m"}:   "ymm2/m256/m16bcst{sae}",
	{"ymm2/m256/m16bcst {er}", "ModRM:r/m"}:    "ymm2/m256/m16bcst{er}",
	{"ymm2/ m256/m16bcst {sae}", "ModRM:r/m"}:  "ymm2/m256/m16bcst{sae}",
	{"ymm2/ m256/m16bcst {er}", "ModRM:r/m"}:   "ymm2/m256/m16bcst{er}",
	{"ymm2/ m256/m16bcst", "ModRM:r/m"}:        "ymm2/m256/m16bcst",
	{"ymm2/m256/ m16bcst", "ModRM:r/m"}:        "ymm2/m256/m16bcst",
	{"ymm2/ m256/m32bcst", "ModRM:r/m"}:        "ymm2/m256/m32bcst",
	{"ymm2/ m256/m64bcst", "ModRM:r/m"}:        "ymm2/m256/m64bcst",
	{"ymm2/m256 {sae}", "ModRM:r/m"}:           "ymm2/m256{sae}",
	{"ymm2/m256 {er}", "ModRM:r/m"}:            "ymm2/m256{er}",
	...
	{"ymm3/m256/m16bcst", "ModRM:r/m"}:         "ymm2/m256/m16bcst",
	{"ymm3/ m256/m16bcst", "ModRM:r/m"}:        "ymm2/m256/m16bcst",
	{"ymm3/m256/m32bcst", "ModRM:r/m"}:         "ymm2/m256/m32bcst",
	{"ymm3/m256/m64bcst", "ModRM:r/m"}:         "ymm2/m256/m64bcst",
	...
	{"zmm1", "EVEX.vvvv"}:                      "zmmV",
	{"zmm1", "ModRM:r/m"}:                      "zmm2",
	{"zmm1 {k1}{z}", "VEX.vvvv"}:               "zmmV {k1}{z}",
	{"zmm1 {k1}{z}", "EVEX.vvvv"}:              "zmmV {k1}{z}",
	{"zmm1{k1}{z}", "ModRM:reg"}:               "zmm1 {k1}{z}",
	{"zmm1{k1}{z}", "ModRM:r/m"}:               "zmm2 {k1}{z}",
	{"zmm1/m512/ m16bcst", "ModRM:r/m"}:        "zmm2/m512/m16bcst",
	{"zmm2{sae}", "ModRM:reg"}:                 "zmm1{sae}",
	{"zmm2", "ModRM:reg"}:                      "zmm1",
	{"zmm2", "VEX.vvvv"}:                       "zmmV",
	{"zmm2", "EVEX.vvvv"}:                      "zmmV",
	{"zmm2+3", "EVEX.vvvv"}:                    "zmmV",
	{"zmm2/m512/m32bcst {sae}", "ModRM:r/m"}:   "zmm2/m512/m32bcst{sae}",
	{"zmm2/m512/m32bcst {er}", "ModRM:r/m"}:    "zmm2/m512/m32bcst{er}",
	{"zmm2/m512/m64bcst {sae}", "ModRM:r/m"}:   "zmm2/m512/m64bcst{sae}",
	{"zmm2/m512/m64bcst {er}", "ModRM:r/m"}:    "zmm2/m512/m64bcst{er}",
	{"zmm2/ m512/m16bcst { sae}", "ModRM:r/m"}: "zmm2/m512/m16bcst{sae}",
	{"zmm2/ m512/m16bcst {sae}", "ModRM:r/m"}:  "zmm2/m512/m16bcst{sae}",
	{"zmm2/ m512/m16bcst {er}", "ModRM:r/m"}:   "zmm2/m512/m16bcst{er}",
	{"zmm2/ m512/m16bcst", "ModRM:r/m"}:        "zmm2/m512/m16bcst",
	{"zmm2/m512/ m16bcst {er}", "ModRM:r/m"}:   "zmm2/m512/m16bcst{er}",
	{"zmm2/m512/ m16bcst", "ModRM:r/m"}:        "zmm2/m512/m16bcst",
	{"zmm2/ m512/m32bcst {er}", "ModRM:r/m"}:   "zmm2/m512/m32bcst{er}",
	{"zmm2/ m512/m64bcst {er}", "ModRM:r/m"}:   "zmm2/m512/m64bcst{er}",
	{"zmm3/ m512/m16bcst {sae}", "ModRM:r/m"}:  "zmm2/m512/m16bcst{sae}",
	{"zmm3/ m512/m16bcst {er}", "ModRM:r/m"}:   "zmm2/m512/m16bcst{er}",
	{"zmm3/ m512/m16bcst", "ModRM:r/m"}:        "zmm2/m512/m16bcst",
	{"zmm3/m512/m16bcst {sae}", "ModRM:r/m"}:   "zmm2/m512/m16bcst{sae}",
	{"zmm3/m512/m16bcst {er}", "ModRM:r/m"}:    "zmm2/m512/m16bcst{er}",
	{"zmm3/m512/m16bcst", "ModRM:r/m"}:         "zmm2/m512/m16bcst",
	{"zmm3/m512/m32bcst {er}", "ModRM:r/m"}:    "zmm2/m512/m32bcst{er}",
	{"zmm3/m512/m32bcst{er}", "ModRM:r/m"}:     "zmm2/m512/m32bcst{er}",
	{"zmm3/m512/m32bcst", "ModRM:r/m"}:         "zmm2/m512/m32bcst",
	{"zmm3/m512/m32bcst{sae}", "ModRM:r/m"}:    "zmm2/m512/m32bcst{sae}",
	{"zmm3/m512/m64bcst{sae}", "ModRM:r/m"}:    "zmm2/m512/m64bcst{sae}",
	{"zmm3/m512/m64bcst{er}", "ModRM:r/m"}:     "zmm2/m512/m64bcst{er}",
	{"zmm3/m512/m64bcst {er}", "ModRM:r/m"}:    "zmm2/m512/m64bcst{er}",
	{"zmm3/m512/m64bcst", "ModRM:r/m"}:         "zmm2/m512/m64bcst",
	{"zmm1/m512 {k1}{z}", "ModRM:r/m"}:         "zmm2/m512 {k1}{z}",
	{"zmm3/m512", "ModRM:r/m"}:                 "zmm2/m512",
}
...
var encodings = map[string][]string{
	...
	"CALL rel16":               {"Offset"},
	"CALL rel32":               {"Offset"},
	"HRESET imm8, <EAX>":       {"imm8", "Implicit EAX"},
	...
	"SENDUIPI reg":             {"ModRM:r/m (r)"},
	"TPAUSE r32, <edx>, <eax>": {"ModRM:r/m (r)", "Implicit EDX", "Implicit EAX"},
	"XCHG AX, r16":             {"AX (r, w)", "opcode + rd (r, w)"},
	"XCHG EAX, r32":            {"EAX (r, w)", "opcode + rd (r, w)"},
	"XCHG RAX, r64":            {"RAX (r, w)", "opcode + rd (r, w)"},
	"UMWAIT r32, <edx>, <eax>": {"ModRM:r/m (r)", "Implicit EDX", "Implicit EAX"},
...
var encodeOK = map[[2]string]bool{
	...
	{"EAX", "AX/EAX/RAX"}:                      true,
	{"EAX", "EAX"}:                             true,
	{"<EAX>", "Implicit EAX"}:                  true,
	{"<EDX>", "Implicit EDX"}:                  true,
	{"ES", "ES"}:                               true,
	{"FS", "FS"}:                               true,
	{"GS", "GS"}:                               true,
	{"imm16", "imm16"}:                         true,
	...
	{"imm8", "imm8[3:0]"}:                      true,
	{"imm8", "imm8"}:                           true,
	{"k1 {k2}", "ModRM:reg"}:                   true,
	{"k1", "ModRM:reg"}:                        true,
	{"k2/m16", "ModRM:r/m"}:                    true,
	{"k2/m32", "ModRM:r/m"}:                    true,
	{"k2/m64", "ModRM:r/m"}:                    true,
	{"k2/m8", "ModRM:r/m"}:                     true,
	{"k2", "ModRM:r/m"}:                        true,
	{"kV", "VEX.1vvv"}:                         true,
	{"m128", "ModRM:r/m"}:                      true,
	...
	{"ptr16:16", "Segment + Absolute Address"}: true,
	{"ptr16:32", "Offset"}:                     true,
	{"ptr16:32", "Segment + Absolute Address"}: true,
	{"r16", "ModRM:reg"}:                       true,
	...
	{"r/m32{er}", "ModRM:r/m"}:                 true,
	{"r/m32", "ModRM:r/m"}:                     true,
	{"r/m32{sae}", "ModRM:r/m"}:                true,
	{"r/m64{er}", "ModRM:r/m"}:                 true,
	{"r/m64", "ModRM:r/m"}:                     true,
	{"r/m64{sae}", "ModRM:r/m"}:                true,
	{"r/m8", "ModRM:r/m"}:                      true,
	{"rmr16", "ModRM:r/m"}:                     true,
	{"rmr32", "ModRM:r/m"}:                     true,
	{"rmr64", "ModRM:r/m"}:                     true,
	{"sibmem", "ModRM:r/m"}:                    true,
	{"Sreg", "ModRM:reg"}:                      true,
	{"SS", "SS"}:                               true,
	{"ST(0)", "ST(0)"}:                         true,
	{"ST(i)", "ST(i)"}:                         true,
	...
	{"vm64z", "VSIB"}:                          true,
	{"vm64z {k1}", "VSIB"}:                     true,
	{"<XMM0-1>", "Implicit XMM0—1"}:            true,
	{"<XMM0-7>", "Implicit XMM0-7"}:            true,
	{"<XMM0>", "implicit XMM0"}:                true,
	{"<XMM0>", "Implicit XMM0"}:                true,
	{"<XMM0>", "<XMM0>"}:                       true,
	{"<XMM1-2>", "Implicit XMM1—2"}:            true,
	{"xmm1 {k1}{z}", "ModRM:reg"}:              true,
	{"xmm1 {k1}", "ModRM:reg"}:                 true,
	{"xmm1", "ModRM:reg"}:                      true,
	{"<XMM2-6>", "Implicit XMM2—6"}:            true,
	{"xmm2 {k1}{z}", "ModRM:r/m"}:              true,
	{"xmm2/m32/m16bcst", "ModRM:r/m"}:          true,
	{"xmm2/m64/m16bcst", "ModRM:r/m"}:          true,
	{"xmm2/m128 {k1}{z}", "ModRM:r/m"}:         true,
	{"xmm2/m128/m16bcst{sae}", "ModRM:r/m"}:    true,
	{"xmm2/m128/m16bcst{er}", "ModRM:r/m"}:     true,
	{"xmm2/m128/m16bcst", "ModRM:r/m"}:         true,
	{"xmm2/m128/m32bcst", "ModRM:r/m"}:         true,
	{"xmm2/m128/m64bcst", "ModRM:r/m"}:         true,
	{"xmm2/m128", "ModRM:r/m"}:                 true,
	{"xmm2/m16 {k1}{z}", "ModRM:r/m"}:          true,
	{"xmm2/m16{sae}", "ModRM:r/m"}:             true,
	{"xmm2/m16{er}", "ModRM:r/m"}:              true,
	{"xmm2/m16", "ModRM:r/m"}:                  true,
	{"xmm2/m32{er}", "ModRM:r/m"}:              true,
	{"xmm2/m32", "ModRM:r/m"}:                  true,
	{"xmm2/m32{sae}", "ModRM:r/m"}:             true,
	{"xmm2/m32 {k1}{z}", "ModRM:r/m"}:          true,
	{"xmm2/m64 {k1}{z}", "ModRM:r/m"}:          true,
	{"xmm2/m64{sae}", "ModRM:r/m"}:             true,
	{"xmm2/m64{er}", "ModRM:r/m"}:              true,
	{"xmm2/m64/m32bcst", "ModRM:r/m"}:          true,
	{"xmm2/m64", "ModRM:r/m"}:                  true,
	{"xmm2/m64{sae}", "ModRM:r/m"}:             true,
	{"xmm2/m8", "ModRM:r/m"}:                   true,
	{"xmm2", "ModRM:r/m"}:                      true,
	{"<XMM4-6>", "Implicit XMM4—6"}:            true,
	{"xmmIH", "imm8[7:4]"}:                     true,
	{"xmmV", "EVEX.vvvv"}:                      true,
	{"xmmV {k1}{z}", "VEX.vvvv"}:               true,
	{"xmmV {k1}{z}", "EVEX.vvvv"}:              true,
	{"xmmV", "VEX.vvvv"}:                       true,
	{"ymm1 {k1}{z}", "ModRM:reg"}:              true,
	{"ymm1 {k1}", "ModRM:reg"}:                 true,
	{"ymm1", "ModRM:reg"}:                      true,
	{"ymm2/m256 {k1}{z}", "ModRM:r/m"}:         true,
	{"ymm2/m256/m16bcst{sae}", "ModRM:r/m"}:    true,
	{"ymm2/m256/m16bcst{er}", "ModRM:r/m"}:     true,
	{"ymm2/m256/m16bcst", "ModRM:r/m"}:         true,
	{"ymm2/m256/m32bcst{sae}", "ModRM:r/m"}:    true,
	{"ymm2/m256/m32bcst{er}", "ModRM:r/m"}:     true,
	{"ymm2/m256/m32bcst", "ModRM:r/m"}:         true,
	{"ymm2/m256/m64bcst{sae}", "ModRM:r/m"}:    true,
	{"ymm2/m256/m64bcst{er}", "ModRM:r/m"}:     true,
	{"ymm2/m256/m64bcst", "ModRM:r/m"}:         true,
	{"ymm2/m256{sae}", "ModRM:r/m"}:            true,
	{"ymm2/m256{er}", "ModRM:r/m"}:             true,
	{"ymm2/m256", "ModRM:r/m"}:                 true,
	{"ymm2 {k1}{z}", "ModRM:r/m"}:              true,
	{"ymm2", "ModRM:r/m"}:                      true,
	{"ymmIH", "imm8[7:4]"}:                     true,
	{"ymmV {k1}{z}", "VEX.vvvv"}:               true,
	{"ymmV {k1}{z}", "EVEX.vvvv"}:              true,
	{"ymmV", "VEX.vvvv"}:                       true,
	{"ymmV", "EVEX.vvvv"}:                      true,
	{"zmm1 {k1}{z}", "ModRM:reg"}:              true,
	{"zmm1 {k1}", "ModRM:reg"}:                 true,
	{"zmm1{sae}", "ModRM:reg"}:                 true,
	{"zmm1{er}", "ModRM:reg"}:                  true,
	{"zmm1", "ModRM:reg"}:                      true,
	{"zmm2/m512 {k1}{z}", "ModRM:r/m"}:         true,
	{"zmm2/m512/m16bcst{sae}", "ModRM:r/m"}:    true,
	{"zmm2/m512/m16bcst{er}", "ModRM:r/m"}:     true,
	{"zmm2/m512/m16bcst", "ModRM:r/m"}:         true,
	{"zmm2/m512/m32bcst{er}", "ModRM:r/m"}:     true,
	{"zmm2/m512/m32bcst", "ModRM:r/m"}:         true,
	{"zmm2/m512/m32bcst{sae}", "ModRM:r/m"}:    true,
	{"zmm2/m512/m64bcst{er}", "ModRM:r/m"}:     true,
	{"zmm2/m512/m64bcst", "ModRM:r/m"}:         true,
	{"zmm2/m512/m64bcst{sae}", "ModRM:r/m"}:    true,
	{"zmm2/m512", "ModRM:r/m"}:                 true,
	{"zmm2 {k1}{z}", "ModRM:r/m"}:              true,
	{"zmm2", "ModRM:r/m"}:                      true,
	{"zmmV", "VEX.vvvv"}:                       true,
	{"zmmV", "EVEX.vvvv"}:                      true,
	{"zmmV {k1}{z}", "VEX.vvvv"}:               true,
	{"zmmV {k1}{z}", "EVEX.vvvv"}:              true,
}
...
var fixup = map[[2]string][]fixer{
	...
	{"GF2P8AFFINEQB xmm1, xmm2/m128, imm8", "66 0F3A CE /r ib"}:    {fixOpcode("66 0F 3A CE /r ib")},
	{"GF2P8AFFINEINVQB xmm1, xmm2/m128, imm8", "66 0F3A CF /r ib"}: {fixOpcode("66 0F 3A CF /r ib")},
	{"GF2P8MULB xmm1, xmm2/m128", "66 0F38 CF /r"}:                 {fixOpcode("66 0F 38 CF /r")},
	{"KSHIFTRB k1, k2, imm8", "VEX.L0.66.0F3A.W0 30 /r"}:           {fixOpcode("VEX.L0.66.0F3A.W0 30 /r ib")},
	{"KSHIFTRW k1, k2, imm8", "VEX.L0.66.0F3A.W1 30 /r"}:           {fixOpcode("VEX.L0.66.0F3A.W1 30 /r ib")},
	{"KSHIFTRD k1, k2, imm8", "VEX.L0.66.0F3A.W0 31 /r"}:           {fixOpcode("VEX.L0.66.0F3A.W0 31 /r ib")},
	{"KSHIFTRQ k1, k2, imm8", "VEX.L0.66.0F3A.W1 31 /r"}:           {fixOpcode("VEX.L0.66.0F3A.W1 31 /r ib")},
	{"KSHIFTLB k1, k2, imm8", "VEX.L0.66.0F3A.W0 32 /r"}:           {fixOpcode("VEX.L0.66.0F3A.W0 32 /r ib")},
	{"KSHIFTLW k1, k2, imm8", "VEX.L0.66.0F3A.W1 32 /r"}:           {fixOpcode("VEX.L0.66.0F3A.W1 32 /r ib")},
	{"KSHIFTLD k1, k2, imm8", "VEX.L0.66.0F3A.W0 33 /r"}:           {fixOpcode("VEX.L0.66.0F3A.W0 33 /r ib")},
	{"KSHIFTLQ k1, k2, imm8", "VEX.L0.66.0F3A.W1 33 /r"}:           {fixOpcode("VEX.L0.66.0F3A.W1 33 /r ib")},
	...
	{"NOP", "NP 90"}:                                               {fixOpcode("90")},       // The manual now says NP, but its examples use 66.
	{"NOP r/m16", "NP 0F 1F /0"}:                                   {fixOpcode("0F 1F /0")}, // The manual now says NP, but its examples use 66.
	{"NOP r/m32", "NP 0F 1F /0"}:                                   {fixOpcode("0F 1F /0")}, // The manual now says NP, but its examples use 66.
	{"VMOVLPD xmm2, xmmV, m64", "VEX.128.66.0F.WIG 12 /r"}:         {fixArg(0, "xmm1")},
...
func cleanup(insts []*instruction) []*instruction {
	...
	for seq, inst := range insts {
		...
		case "ENCODEKEY128 r32, r32, <XMM0-2>, <XMM4-6>":
			inst.syntax = "ENCODEKEY128 r32, r32, <XMM0>, <XMM1-2>, <XMM4-6>"
		case "ENCODEKEY256 r32, r32 <XMM0-6>":
			inst.syntax = "ENCODEKEY256 r32, r32, <XMM0-1>, <XMM2-6>"
		...
		case "VFIXUPIMMPS xmm1 {k1}{z}, xmm2, xmm3/m128/m32bcst, imm8",
			...
			if !strings.HasSuffix(inst.opcode, " ib") {
				inst.opcode += " ib"
			}
		case "VP4DPWSSDzmm1{k1}{z},zmm2+3, m128":
			inst.syntax = "VP4DPWSSD zmm1 {k1}{z}, zmm2, m128"
		case "ibVPERMILPS zmm1 {k1}{z}, zmm2/m512/m32bcst, imm8":
			inst.opcode += " ib"
			inst.syntax = "VPERMILPS zmm1 {k1}{z}, zmm2/m512/m32bcst, imm8"
		case "VREDUCESD xmm1 {k1}{z}, xmm2, xmm3/m64{sae}, imm8/r":
			inst.opcode += " /r ib"
			inst.syntax = "VREDUCESD xmm1 {k1}{z}, xmm2, xmm3/m64{sae}, imm8"
		...
		for i, arg := range args {
			...
			case enc == "imm8/26/32":
				enc = "imm8/16/32"
			case enc == "SIB.index(r)":
				enc = "SIB (r)"
			case enc == "BaseReg (R): VSIB:base, VectorReg(R): VSIB:index",
				enc == "BaseReg (R): VSIB:base, VectorReg(R):VSIB:index",
				enc == "VectorReg(R): VSIB:index":
				enc = "VSIB (r)"
			...
			case strings.HasSuffix(enc, "(r)") && !strings.HasSuffix(enc, " (r)"):
				enc = strings.TrimSuffix(enc, "(r)") + " (r)"
			}
			inst.args[i] = enc
			...
			if strings.HasPrefix(enc, "ModRM:reg") && !strings.Contains(inst.opcode, "/r") && !strings.Contains(inst.opcode, "/vsib") {
				// The opcode is taken up with something else. Bug in table.
				log.Fatalf("p.%d: %s has invalid encoding %s: no reg field in %s", inst.page, inst.syntax, arg, inst.opcode)
			}
			if strings.HasPrefix(enc, "ModRM:r/m") && strings.Contains(inst.opcode, "/vsib") {
				// The r/m operand will clash with the placeholder used to
				// specify the (V)SIB byte.
				log.Fatalf("p.%d: %s has invalid encoding %s: no r/m field in %s", inst.page, inst.syntax, arg, inst.opcode)
			}
