...
impl VirtAddr {
    ...
    #[inline]
    #[track_caller]
    pub const fn range_exclusive(start: Self, end: Self) -> VirtAddrRange {
        assert!(start.0 < end.0);
        VirtAddrRange::new(start, VirtAddr(end.0 - 1))
    }
    ...
    #[inline]
    #[track_caller]
    pub const fn range_inclusive(start: Self, end: Self) -> VirtAddrRange {
        assert!(start.0 <= end.0);
